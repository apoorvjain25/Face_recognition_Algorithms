...
face = cv2.CascadeClassifier('C:\\Python27\\Test\\vision-systems\\Python\\Haar\\haarcascade_frontalcatface.xml')
glass_cas = cv2.CascadeClassifier('C:\\Python27\\Test\\vision-systems\\Python\\Haar\\haarcascade_eye_tree_eyeglasses.xml')

WHITE = [255, 255, 255]

def FileRead():
    Info = open("C:\\Python27\\Test\\vision-systems\\Python\\Names.txt", "r")                       # Open th text file in readmode
...
def AddName():
    ...
    Info = open("C:\\Python27\\Test\\vision-systems\\Python\\Names.txt", "r+")
