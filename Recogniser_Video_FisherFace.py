...
face_cascade = cv2.CascadeClassifier('C:\\Python27\\Test\\vision-systems\\Python\\Haar\\haarcascade_frontalcatface.xml')
eye_cascade = cv2.CascadeClassifier('C:\\Python27\\Test\\vision-systems\\Python\\Haar\\haarcascade_eye.xml')
recognise = cv2.face.FisherFaceRecognizer_create(2, 40)                        # creating FISHER FACE RECOGNISER
recognise.read("C:\\Python27\\Test\\vision-systems\\Python\\Recogniser\\trainingDataFisher.xml")                            # Load the training data from the trainer to recognise the faces
