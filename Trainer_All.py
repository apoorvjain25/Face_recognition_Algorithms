...
path = 'C:\\Python27\\Test\\vision-systems\\Python\\dataSet'                                        # path to the photos
...
EigenFace.save('C:\\Python27\\Test\\vision-systems\\Python\\Recogniser\\trainingDataEigan.xml')
print('FILE SAVED..')
FisherFace.train(FaceList, IDs)
print('FISHER FACE RECOGNISER COMPLETE...')
FisherFace.save('C:\\Python27\\Test\\vision-systems\\Python\\Recogniser\\trainingDataFisher.xml')
print('Fisher Face XML saved... ')
LBPHFace.train(FaceList, IDs)
print('LBPH FACE RECOGNISER COMPLETE...')
LBPHFace.save('C:\\Python27\\Test\\vision-systems\\Python\\Recogniser\\trainingDataLBPH.xml')
